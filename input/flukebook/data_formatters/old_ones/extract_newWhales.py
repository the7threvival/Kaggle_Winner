...
if __name__=="__main__":
  ...
  if(len(sys.argv) < 3):
    print()
    print("Usage: python {} input.csv output_name [skip]".format(sys.argv[0]))
  ...
  if skip:
    ...
    print("2) IDs with \"{}\" occurence(s) will be called 'new_whale'.".format(occur))
